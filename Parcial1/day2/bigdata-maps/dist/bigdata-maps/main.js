...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_services_marker_service__WEBPACK_IMPORTED_MODULE_5__["MarkerService"], _services_pop_up_service__WEBPACK_IMPORTED_MODULE_6__["PopUpService"]],
...
var DataApiService = /** @class */ (function () {
    ...
    function DataApiService(http) {
        this.http = http;
        this.apiURL = 'http://localhost:10010/';
        /*========================================
    ...
    DataApiService.prototype.getEstados = function () {
        ...
        return this.http.get(this.apiURL + 'entidades', this.httpOptions)
    ...
    DataApiService.prototype.getMunicipios = function (idestado) {
        ...
        return this.http.get(this.apiURL + 'municipios?entidad=' + idestado, this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    };
    DataApiService.prototype.getUnidades = function () {
        console.log('unidades: ' + this.apiURL);
        return this.http.get(this.apiURL + 'bancos', this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    };
    DataApiService.prototype.getDenues = function (idestado, idmunicipio, tipo) {
        console.log('denues: ' + this.apiURL + idestado);
        return this.http.get(this.apiURL + 'denues?entidad=' + idestado +
...
module.exports = __webpack_require__(/*! /home/cealmeba/Documentos/BASEDEDATOS/Parcial1/day2/bigdata-maps/src/main.ts */"./src/main.ts");
